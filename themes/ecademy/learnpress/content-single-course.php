...
?>
    ...
    <div class="page-title-area <?php if( $is_rating == true && $is_breadcrumb == true ): ?>ptb-50<?php endif; ?>" <?php if( get_field('course_single_background_image_main') != '' ): ?>style="background-image:url(<?php echo esc_url(get_field('course_single_background_image_main')); ?>);"<?php endif; ?>>
            <div class="container">
